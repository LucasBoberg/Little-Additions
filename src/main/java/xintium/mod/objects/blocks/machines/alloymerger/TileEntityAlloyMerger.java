...
public class TileEntityAlloyMerger extends TileEntity implements IInventory, ITickable {
    ...
    {
        return this.hasCustomName() ? this.customName : "container.alloy_merger";
    }
    ...
    public void update()
    {
        ...
        if(!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockAlloyMerger.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = AlloyMergerRecipes.getInstance().getAlloyMergerResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
    ...
    public void smeltItem()
    {
        if(this.canSmelt())
        {
            ...
            ItemStack result = AlloyMergerRecipes.getInstance().getAlloyMergerResult(input1, input2);
            ItemStack output = (ItemStack) this.inventory.get(3);
