...
public class BlockCrusher extends BlockBase implements ITileEntityProvider {
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos) {
        ...
        if(active) worldIn.setBlockState(pos, BlockInit.CRUSHER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(RUNNING, true), 3);
        else worldIn.setBlockState(pos, BlockInit.CRUSHER.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(RUNNING, false), 3);
    ...
    private TileEntityCrusher getTile(World worldIn, BlockPos pos) {
        return (TileEntityCrusher) worldIn.getTileEntity(pos);
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntityCrusher tileEntityCrusherr = (TileEntityCrusher) worldIn.getTileEntity(pos);
        InventoryHelper.dropInventoryItems(worldIn, pos, tileEntityCrusherr);
