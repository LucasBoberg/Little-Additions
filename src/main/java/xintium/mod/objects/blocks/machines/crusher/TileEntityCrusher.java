...
public class TileEntityCrusher extends TileEntity implements IInventory, ITickable, ISidedInventory {
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = CrusherRecipes.getInstance().getCrusherResult((ItemStack)this.inventory.get(0));
    ...
    public void smeltItem()
    {
        if(this.canSmelt())
        {
            ...
            ItemStack result = CrusherRecipes.getInstance().getCrusherResult(input);
            ItemStack output = (ItemStack) this.inventory.get(2);
