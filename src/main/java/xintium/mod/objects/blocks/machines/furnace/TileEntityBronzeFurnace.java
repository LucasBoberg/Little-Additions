...
public class TileEntityBronzeFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.furnaceCustomName : "container.bronze_furnace";
    }
    ...
    public static void registerFixesFurnace(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityBronzeFurnace.class, new String[]{"Items"}));
    }
