...
public class WorldGenCustomOres implements IWorldGenerator {
	...
	private WorldGenerator ore_copper, ore_tin, ore_silver;

	public WorldGenCustomOres() {
		ore_copper = new WorldGenMinable(BlockInit.ORE_COPPER.getDefaultState(), 9);
		ore_tin = new WorldGenMinable(BlockInit.ORE_TIN.getDefaultState(), 8);
		ore_silver = new WorldGenMinable(BlockInit.ORE_SILVER.getDefaultState(), 8);
	}
